...
.movieInfoBox .leftColumn {
  width: 40%;
  flex-shrink: 0;
}
.movieInfoBox .leftColumn .modalBtn {
  display: block;
  margin: 2rem 0;
}
.movieInfoBox .leftColumn .extraInfo {
  border: 1px solid rgba(181, 204, 245, 0.1);
  padding: 45px 40px;
}
.movieInfoBox .leftColumn .extraInfo .leftHeader {
  font-size: 1.5rem;
  padding-bottom: 1rem;
}
.movieInfoBox .leftColumn .extraInfo .listHeader {
  font-size: 1rem;
  padding: 0.2rem 0;
  color: #d3dae2;
  opacity: 0.5;
}
.movieInfoBox .leftColumn .extraInfo .listInfo {
  font-size: 1.2rem;
  padding: 0.5rem;
  margin-bottom: 2rem;
}
.movieInfoBox .rightColumn {
  width: calc(60% - 2rem);
}
.movieInfoBox .rightColumn .rightTitle {
  font-size: 2.5rem;
  padding: 2rem 0;
}
.movieInfoBox .rightColumn .descriptionContainer p {
  font-size: 1.25rem;
  line-height: 1.5;
}
